...
def Agendar():
  ...
  # Se tudo correto faz o registro no banco de dados.
    ...
    ano.delete(0,"end") 
    hora.delete(0,"end")
    # Adicionar  dados na tabela atividade
    dadosativ = "INSERT INTO `atividade` (nome_atividade,tipo_atividade,local_atividade) VALUES('"+ativ.get()+"','"+tipoativ.get()+"','"+local.get()+"')"
